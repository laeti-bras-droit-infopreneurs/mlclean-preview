---
title: "Désinfection de logement"
...
description: >-
  ...
  Certibiocide, devis gratuit sous 72 h.
---

Nettoyer rend un logement propre ; désinfecter le rend **sain**. Dans
certaines situations, le nettoyage seul ne suffit pas : il faut traiter les
...
- après un [décès]({{ '/situations/nettoyage-apres-deces/' | relative_url }})
  dans le logement ;
- après une maladie contagieuse (comme la
  [gale]({{ '/situations/desinfection-gale/' | relative_url }})) ;
- en présence de nuisibles ou après leur
  [traitement]({{ '/situations/nuisibles-deratisation-desinsectisation/' | relative_url }}) ;
...
2. **Préparation** : nettoyage préalable si besoin (une désinfection n'est
   efficace que sur des surfaces nettoyées).
3. **Traitement** : application des produits professionnels adaptés, surface
   par surface, y compris les points de contact (poignées, interrupteurs,
   sanitaires).
