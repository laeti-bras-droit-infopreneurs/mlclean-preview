...
accroche: >-
  Vider la maison d'un proche dans le cadre d'une succession : tri
  respectueux, coordination avec le notaire, et un logement rendu prêt
  pour la suite.
description: >-
  Débarras de maison ou d'appartement dans le cadre d'une succession à
  Sarlat et alentours : tri respectueux des souvenirs, coordination avec
...
- **Débarras complet ou partiel** du logement, des dépendances, de la cave
  au grenier ;
- **tri méthodique** : documents administratifs et papiers de famille mis de
...
personnels selon vos instructions. Et quand les héritiers ne sont pas tous
...
quand l'intervention concerne le logement même où la personne est décédée.
