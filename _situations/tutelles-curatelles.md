...
description: >-
  ...
  curatelles) à Sarlat et alentours : devis transmissible au juge,
  facturation au dossier, compte rendu et traçabilité des interventions.
---
...
|---|---|
| Justifier la dépense auprès du juge | Devis détaillé poste par poste, sous 72 h, transmissible tel quel |
| Respecter le budget de la personne | Devis ferme, sans surprise ; le don et le recyclage réduisent les coûts |
| Préserver les biens et documents | Tri systématique : papiers, valeurs et souvenirs inventoriés et remis contre signature si souhaité |
...
- la personne est **associée à l'intervention** chaque fois que son état le
...
vidage d'un logement dans le cadre d'une
[succession]({{ '/situations/debarras-succession/' | relative_url }}) ou d'une
