---
title: "Nettoyage de maintien à domicile"
pole: nettoyage-desinfection
accroche: >-
  Un logement entretenu, c'est souvent la condition pour rester chez soi.
  Nous aidons les personnes âgées ou fragilisées à garder un cadre de vie sain.
description: >-
  Nettoyage de maintien à domicile pour personnes âgées ou fragilisées à
  Sarlat et alentours : remises à niveau ponctuelles ou régulières, en
  coordination avec les aides à domicile et les services sociaux.
---
...
- **remise à niveau initiale** quand le logement s'est trop dégradé pour
  qu'un entretien courant suffise (l'aide à domicile peut ensuite reprendre
  son travail dans de bonnes conditions) ;
- **gros nettoyages périodiques** : vitres en hauteur, dessus d'armoires,
  derrière les meubles, électroménager en profondeur ;
- **désencombrement de sécurité** : libérer les passages, réduire les risques
  de chute ;
...
un tiers (famille, tutelle, organisme).
