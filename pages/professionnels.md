...
permalink: /professionnels/
sous_titre: "CCAS, travailleurs sociaux, tutelles, établissements : un partenaire de terrain fiable pour vos situations d'habitat dégradé."
description: >-
...
- la personne est **associée aux décisions** chaque fois que possible (ce
  qu'on garde, ce qu'on donne, ce qu'on jette) ;
- les documents administratifs et objets personnels sont **systématiquement
  préservés** et remis à qui de droit ;
- l'intervention est **discrète** vis-à-vis du voisinage et strictement
  confidentielle ;
- le rythme peut être adapté, en plusieurs passages si nécessaire, en
...
{% include form-devis.html origine="espace-professionnels" %}
