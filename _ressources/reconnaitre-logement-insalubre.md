...
description: >-
  Guide pratique : comment reconnaître un logement insalubre ? Les signes
  d'alerte, la différence avec le simple désordre, et les interlocuteurs à
  contacter en Dordogne et alentours.
---
...
- odeurs fortes et persistantes sur le palier ou depuis les fenêtres ;
- volets fermés en permanence, courrier qui déborde ;
...
- **Accumulation** : déchets, denrées périmées, objets rendant des pièces
  inutilisables ;
- **humidité et moisissures** étendues sur les murs ou plafonds ;
- **installations dégradées** : sanitaires hors d'usage, électricité
  dangereuse, chauffage défaillant ;
- **nuisibles installés** : traces de rongeurs, cafards visibles de jour ;
...
2. **Dans les autres cas : la mairie (CCAS)** de la commune. C'est
   l'interlocuteur de proximité, qui peut évaluer et mobiliser les services
   compétents.
3. **L'assistante sociale de secteur**, si la personne est déjà suivie ou en
   grande difficulté sociale.
4. **Le médecin traitant** de la personne, souvent le mieux placé pour faire
   accepter une aide.
